...
export default function Stats() {
  return (
    <section className="py-14 px-4 sm:px-6 lg:px-8 bg-plum" aria-label="Statystyki">
      <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8" role="list">
        {stats.map(({ value, label }, i) => (
          <SectionReveal key={label} delay={i * 0.08} className="text-center" >
            <div role="listitem">
              <div className="font-display text-3xl sm:text-4xl font-semibold text-rose-300 mb-1">{value}</div>
