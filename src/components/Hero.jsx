  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-6 sm:py-24 w-full">
        <div className="grid grid-cols-[1.3fr_1fr] sm:grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-10 lg:gap-16 items-start sm:items-center">
          <div>
            <motion.div
              initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
              className="inline-flex items-center gap-2 bg-white/70 border border-rose-200 text-rose-600 rounded-full px-3 py-1 sm:px-4 sm:py-1.5 text-xs sm:text-sm font-medium mb-3 sm:mb-6"
            >
          ...
          <motion.div
            ...
            className="flex items-start sm:items-center justify-center pt-1 sm:pt-0"
          >
